    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flingContainer.setOnItemClickListener(new SwipeFlingAdapterView.OnItemClickListener() {
            ...
            public void onItemClicked(int itemPosition, Object dataObject) {
                Toast.makeText(cardswiper.this, "clicked", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void oppositeSexUser()
    {
        ...
        userDb.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if(dataSnapshot.exists() && !dataSnapshot.child("connection").child("nope").hasChild(currentUser.getUid()) && !dataSnapshot.child("connection").child("yeps").hasChild(currentUser.getUid()) )
                {
                    String imageUrl = "default";
                    if(dataSnapshot.child("profileImage").getValue().toString()!="default")
                    {
